                                    ...
                                    <form class="mx-1 mx-md-4" method="POST" action="registerLogic.php">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="user_type" style="width:150px;margin-top:10px" class="selectpicker form-control">
                                        ...
                                        <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                            <button type="submit" name="submit" data-mdb-button-init
                                                data-mdb-ripple-init class="btn btn-primary btn-lg">Sign up</button>
                                        </div>
